classdef (Sealed) WaterKit < handle & mlkinetics.TracerKit
    ...
    methods (Static)
        function this = instance(varargin)
            ...
            if (isempty(uniqueInstance))
                this = mloyxgen.WaterKit(ipr.imaging, ipr.taus);
                uniqueInstance = this;
            else
                this = uniqueInstance;
            end
