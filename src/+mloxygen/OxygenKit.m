classdef (Sealed) OxygenKit < handle & mlkinetics.TracerKit
    ...
    methods (Static)
        function this = instance(varargin)
            ...
            if (isempty(uniqueInstance))
                this = mloyxgen.OxygenKit(ipr.imaging, ipr.taus);
                uniqueInstance = this;
            else
                this = uniqueInstance;
            end
