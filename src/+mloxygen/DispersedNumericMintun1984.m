classdef DispersedNumericMintun1984 < handle & mloxygen.Mintun1984
    ...
    methods (Static)
        function [this,oo,aif] = createFromDeviceKit(devkit, varargin)
            ...
            reshapeArterial = @mloxygen.DispersedNumericMintun1984.reshapeArterial;
            reshapeScanner = @mloxygen.DispersedNumericMintun1984.reshapeScanner;
            ...
            this = mloxygen.DispersedNumericMintun1984( ...
                'devkit', devkit, ...
                'oo', oo, ...
                'solver', 'simulanneal', ...
                'Dt', Dt, ...
        ...
        function [aifTimes,aif,Dt] = reshapeArterial(arterial, scanner, model)
            ...
            extrapolateEarlyLateAif = @mloxygen.DispersedNumericMintun1984.extrapolateEarlyLateAif;
            reshapeScanner = @mloxygen.DispersedNumericMintun1984.reshapeScanner;
            shiftWorldlines = @mloxygen.DispersedNumericMintun1984.shiftWorldlines;
