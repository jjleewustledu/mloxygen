classdef AugmentedNumericMartin1987 < handle & mlpet.AugmentedData & mlpet.TracerKinetics
    ...
    methods (Static)        
        function this = createFromDeviceKit(devkit, devkit2, varargin)
            ...
            [scan_,timesMid_,aif_] = AugmentedNumericMartin1987.mixScannersAifs(varargin{:});
